  ...
  Future<void> _pickAndUploadDocument() async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data['secure_url'] != null) {
        ...
        final doc =
            FirebaseFirestore.instance.collection('module3_documents').doc();
                              ...
                              onPressed: _uploading ? null : () async {
                                ...
                                if (result == 'word') {
                                  final res = await Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (context) => DocumentEditorPage(moduleNumber: 3),
                                    ),
                                  );
                                  if (res == true) {
                                    setState(() {
                                  ...
                                  final res = await Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (context) => CanvasDocumentEditor(moduleNumber: 3),
                                    ),
                                  );
                                  if (res == true) {
                                    setState(() {
