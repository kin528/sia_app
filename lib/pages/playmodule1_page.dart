...
class PlayModule1Page extends StatefulWidget {
  const PlayModule1Page({super.key});

  @override
  State<PlayModule1Page> createState() => _PlayModule1PageState();
}

class _PlayModule1PageState extends State<PlayModule1Page> {
  ...
  Future<void> _loadQuestions() async {
    ...
    try {
      final doc = await FirebaseFirestore.instance.collection('Quiz').doc('module1').get();
      if (doc.exists && doc.data() != null && doc.data()!['questions'] != null) {
        ...
        // Default questions if none in Firestore
  ...
  Future<void> _saveQuestions() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('Quiz').doc('module1').set({
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (_mode == null)
          ? AppBar(
              title: const Text('Play Module 1'),
