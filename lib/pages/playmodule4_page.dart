...
class PlayModule4Page extends StatefulWidget {
  const PlayModule4Page({super.key});

  @override
  State<PlayModule4Page> createState() => _PlayModule4PageState();
}

class _PlayModule4PageState extends State<PlayModule4Page> {
  ...
  Future<void> _loadQuestions() async {
    ...
    try {
      final doc = await FirebaseFirestore.instance.collection('Quiz').doc('module4').get();
  ...
  Future<void> _saveQuestions() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('Quiz').doc('module4').set({
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (_mode == null)
          ? AppBar(
              title: const Text('Play Module 4'),
