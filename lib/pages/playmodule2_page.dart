...
class PlayModule2Page extends StatefulWidget {
  const PlayModule2Page({super.key});

  @override
  State<PlayModule2Page> createState() => _PlayModule2PageState();
}

class _PlayModule2PageState extends State<PlayModule2Page> {
  ...
  Future<void> _loadQuestions() async {
    ...
    try {
      final doc = await FirebaseFirestore.instance.collection('Quiz').doc('module2').get();
  ...
  Future<void> _saveQuestions() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('Quiz').doc('module2').set({
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (_mode == null)
          ? AppBar(
              title: const Text('Play Module 2'),
