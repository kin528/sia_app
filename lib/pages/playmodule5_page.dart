...
class PlayModule5Page extends StatefulWidget {
  const PlayModule5Page({super.key});

  @override
  State<PlayModule5Page> createState() => _PlayModule5PageState();
}

class _PlayModule5PageState extends State<PlayModule5Page> {
  ...
  Future<void> _loadQuestions() async {
    ...
    try {
      final doc = await FirebaseFirestore.instance.collection('Quiz').doc('module5').get();
  ...
  Future<void> _saveQuestions() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('Quiz').doc('module5').set({
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (_mode == null)
          ? AppBar(
              title: const Text('Play Module 5'),
